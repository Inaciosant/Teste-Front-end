  ...
  connectedCallback() {
    this.innerHTML = `
      <section class="w-full bg-[#111111]">
        <div class="grid w-full grid-cols-1 gap-3 px-0 md:px-0 lg:grid-cols-12 lg:grid-rows-[400px_400px] lg:gap-0">
          ...
          <article class="relative min-h-[240px] overflow-hidden bg-[#ececec] lg:min-h-[180px] lg:col-span-6 lg:row-span-1">
            <div
              role="img"
              aria-label="Modelo loira com blazer preto"
              /* Ajustado para 0% e 10% no eixo Y para mostrar o topo da cabeça */
              class="absolute inset-0 bg-cover bg-no-repeat bg-[position:84%_10%] lg:bg-[position:98%_0%]"
              style="background-image: url('./assets/images/grid/3.jpg');"
            ></div>
          ...
          <article class="relative min-h-[180px] overflow-hidden bg-[#0f0f0f] lg:col-span-6 lg:row-span-1">
            <div
              role="img"
              aria-label="Modelo com jaqueta preta e óculos vermelhos"
              /* Ajustado para 5% no eixo Y para focar no rosto e óculos */
              class="absolute inset-0 bg-cover bg-no-repeat bg-[position:40%_10%] lg:bg-[position:38%_5%]"
              style="background-image: url('./assets/images/grid/2.jpg');"
            ></div>
