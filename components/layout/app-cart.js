                ...
                <div class="flex gap-3 items-start mb-5 last:mb-0 px-1">
                    ...
                    <div class="flex-1 flex flex-col pt-0.5">
                        <div class="flex justify-between items-start gap-2">
                            ...
                            <button type="button" data-remove-item data-id="${item.id}" data-size="${item.size}" class="transition-opacity shrink-0 mt-0.5 opacity-60 hover:opacity-100">
                                <img src="./assets/icons/trash.svg" alt="Remover item" class="w-[15px] h-[18px]" />
                            </button>
                        </div>
